...
from hoomd import extrusion_plugin
...
def test_force_and_energy_eval(simulation_factory,
    ...
    example_pair: hoomd.md.pair.Pair = extrusion_plugin.extrusion.ExtrusionPair(
        cell, default_r_cut=0.9677/2.0, mode=mode)
    example_pair.params[("A", "B")] = dict(magForce= 1, placeHolder = 2)
    example_pair.orientation['A'] = (1.0, 0.0, 0.0)
